...
Динамичный трёхмерный аркадный симулятор гонок на выживание, созданный на **Three.js** и **JavaScript**. Управляйте автомобилем, соревнуйтесь с ботами, подбирайте бонусы, уклоняйтесь от дорожных конусов и камней, покупайте новые суперкары в гараже!
...
* **3D Графика и Динамическое Окружение**:
  * Трехмерная сцена на **Three.js** с панорамным 360° Skybox.
...
* **Бонусы**:
  ...
  * ⚡ **Турбо-стрелки** (`arrow.glb`) — дают мощное ускорение.
...
* **Гараж и Магазин Автомобилей**:
  ...
  * Интерактивный просмотр авто и система прокачки характеристик.
